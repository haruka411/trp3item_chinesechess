...
function MoveChessBack()
    ...
    -- effect("text", args, oldchessColor, 1);
    -- effect("text", args, oldchessType, 1);
    -- effect("text", args, newdeschessColor, 1);
    -- effect("text", args, newdeschessType, 1);
...
local playerColor = PlayerColor.Red;
